...
import { ZoomIn, ZoomOut, Maximize2, Tag, GitBranch, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="absolute top-4 left-4 z-10 flex flex-col gap-2">
      <div className="bg-[#0a0a0a]/90 backdrop-blur-sm border border-[#262626] rounded-lg shadow-xl overflow-hidden">
        <CtrlBtn onClick={onZoomIn}    title="Zoom In"    border><ZoomIn    className="w-4 h-4" /></CtrlBtn>
        <CtrlBtn onClick={onZoomOut}   title="Zoom Out"   border><ZoomOut   className="w-4 h-4" /></CtrlBtn>
        <CtrlBtn onClick={onResetView} title="Reset View"       ><Maximize2 className="w-4 h-4" /></CtrlBtn>
      </div>
      <div className="bg-[#0a0a0a]/90 backdrop-blur-sm border border-[#262626] rounded-lg shadow-xl overflow-hidden">
        <CtrlBtn
