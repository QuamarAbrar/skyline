...
const PricingCard = memo(function PricingCard({ tier }: { tier: PricingTier }) {
  return (
    <div
      className={`relative bg-white dark:bg-[#0a0a0a] rounded-xl p-8 flex flex-col transition-all duration-300 ${
        tier.highlighted
          ? 'border-2 border-blue-500 shadow-[0_0_40px_rgba(59,130,246,0.3)] dark:shadow-[0_0_40px_rgba(59,130,246,0.2)] scale-105'
          : 'border border-slate-200 dark:border-[#262626] hover:border-slate-300 dark:hover:border-[#404040] shadow-sm'
      }`}
    >
      {tier.highlighted && (
      ...
      <div className="mb-6">
        ...
        {!tier.highlighted && <p className="text-sm text-slate-500 dark:text-slate-400">{tier.subtitle}</p>}
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">{tier.description}</p>
      </div>
      ...
      <button
        className={`w-full py-3 px-4 rounded-lg font-semibold transition-all duration-200 mb-8 ${
          tier.highlighted
            ...
            : 'bg-slate-100 dark:bg-[#171717] hover:bg-slate-200 dark:hover:bg-[#262626] text-slate-900 dark:text-white border border-slate-200 dark:border-[#262626]'
        }`}
      >
        {tier.cta}
      </button>
...
export const PricingView = memo(function PricingView() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Feature Highlights */}
      <div className="bg-white dark:bg-[#0a0a0a] border border-slate-200 dark:border-[#262626] rounded-xl p-8 mb-12">
      ...
      {/* FAQ Section */}
      <div className="bg-slate-50 dark:bg-[#171717] border border-slate-200 dark:border-[#262626] rounded-xl p-8">
      ...
      <div className="mt-12 text-center">
        ...
        <button className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-colors shadow-lg shadow-blue-500/30 inline-flex items-center gap-2">
